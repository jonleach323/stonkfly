...
Covering all 21 tiles is a hit every round but not a profit: on round 56751 an all-21 automation staked $50, got $42.38 of refunds and $4.41 of pot, and lost $2.56 (5.1%), the fee and haircuts less a share of the pot. Fewer tiles lose about the same on average with more variance. The readout lets the network propose anything from one tile to all 21; the count is not a setting.
